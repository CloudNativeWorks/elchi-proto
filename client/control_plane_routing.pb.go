...
var file_client_control_plane_routing_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x32, 0xfe, 0x04, 0x0a, 0x13, 0x45, 0x6e, 0x76, 0x6f, 0x79,
	...
	0x65, 0x12, 0x64, 0x0a, 0x0b, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b,
	0x12, 0x29, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x5f, 0x70, 0x6c, 0x61, 0x6e, 0x65,
...
var file_client_control_plane_routing_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
...
var file_client_control_plane_routing_proto_depIdxs = []int32{
	11, // 0: control_plane_routing.RegisterControlPlaneRequest.timestamp:type_name -> google.protobuf.Timestamp
	11, // 1: control_plane_routing.GetControlPlaneClusterRequest.timestamp:type_name -> google.protobuf.Timestamp
	11, // 2: control_plane_routing.NotifySnapshotDeliveredRequest.timestamp:type_name -> google.protobuf.Timestamp
	7,  // 3: control_plane_routing.UpdateNodeListRequest.nodes:type_name -> control_plane_routing.NodeInfo
	11, // 4: control_plane_routing.UpdateNodeListRequest.timestamp:type_name -> google.protobuf.Timestamp
	11, // 5: control_plane_routing.NodeInfo.last_seen:type_name -> google.protobuf.Timestamp
	11, // 6: control_plane_routing.HealthCheckResponse.timestamp:type_name -> google.protobuf.Timestamp
	0,  // 7: control_plane_routing.EnvoyRoutingService.RegisterControlPlane:input_type -> control_plane_routing.RegisterControlPlaneRequest
	2,  // 8: control_plane_routing.EnvoyRoutingService.GetControlPlaneCluster:input_type -> control_plane_routing.GetControlPlaneClusterRequest
	4,  // 9: control_plane_routing.EnvoyRoutingService.NotifySnapshotDelivered:input_type -> control_plane_routing.NotifySnapshotDeliveredRequest
	6,  // 10: control_plane_routing.EnvoyRoutingService.UpdateNodeList:input_type -> control_plane_routing.UpdateNodeListRequest
	9,  // 11: control_plane_routing.EnvoyRoutingService.HealthCheck:input_type -> control_plane_routing.HealthCheckRequest
	1,  // 12: control_plane_routing.EnvoyRoutingService.RegisterControlPlane:output_type -> control_plane_routing.RegisterControlPlaneResponse
	3,  // 13: control_plane_routing.EnvoyRoutingService.GetControlPlaneCluster:output_type -> control_plane_routing.GetControlPlaneClusterResponse
	5,  // 14: control_plane_routing.EnvoyRoutingService.NotifySnapshotDelivered:output_type -> control_plane_routing.NotifySnapshotDeliveredResponse
	8,  // 15: control_plane_routing.EnvoyRoutingService.UpdateNodeList:output_type -> control_plane_routing.UpdateNodeListResponse
	10, // 16: control_plane_routing.EnvoyRoutingService.HealthCheck:output_type -> control_plane_routing.HealthCheckResponse
