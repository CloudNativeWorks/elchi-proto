...
var file_client_controller_routing_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x32, 0xee, 0x08, 0x0a, 0x18, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c,
...
var file_client_controller_routing_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_client_controller_routing_proto_goTypes = []any{
	...
	nil,                                          // 22: controller_routing.ControllerRegistryData.ClientsByControllerEntry
	(*timestamppb.Timestamp)(nil),                // 23: google.protobuf.Timestamp
}
var file_client_controller_routing_proto_depIdxs = []int32{
	23, // 0: controller_routing.RegisterControllerRequest.timestamp:type_name -> google.protobuf.Timestamp
	23, // 1: controller_routing.GetControllerClusterRequest.timestamp:type_name -> google.protobuf.Timestamp
	23, // 2: controller_routing.NotifyClientConnectedRequest.timestamp:type_name -> google.protobuf.Timestamp
	7,  // 3: controller_routing.UpdateClientListRequest.clients:type_name -> controller_routing.ClientInfo
	23, // 4: controller_routing.UpdateClientListRequest.timestamp:type_name -> google.protobuf.Timestamp
	23, // 5: controller_routing.ClientInfo.last_seen:type_name -> google.protobuf.Timestamp
	23, // 6: controller_routing.ControllerHealthCheckResponse.timestamp:type_name -> google.protobuf.Timestamp
	23, // 7: controller_routing.ControllerInfo.last_seen:type_name -> google.protobuf.Timestamp
	...
	22, // 11: controller_routing.ControllerRegistryData.clients_by_controller:type_name -> controller_routing.ControllerRegistryData.ClientsByControllerEntry
	...
	23, // 14: controller_routing.NotifyClientDisconnectedRequest.timestamp:type_name -> google.protobuf.Timestamp
	...
	1,  // 25: controller_routing.ControllerRoutingService.RegisterController:output_type -> controller_routing.RegisterControllerResponse
	3,  // 26: controller_routing.ControllerRoutingService.GetControllerCluster:output_type -> controller_routing.GetControllerClusterResponse
	5,  // 27: controller_routing.ControllerRoutingService.NotifyClientConnected:output_type -> controller_routing.NotifyClientConnectedResponse
	8,  // 28: controller_routing.ControllerRoutingService.UpdateClientList:output_type -> controller_routing.UpdateClientListResponse
	13, // 29: controller_routing.ControllerRoutingService.ListControllers:output_type -> controller_routing.ListControllersResponse
	15, // 30: controller_routing.ControllerRoutingService.ListClientsByController:output_type -> controller_routing.ListClientsByControllerResponse
	19, // 31: controller_routing.ControllerRoutingService.GetAllRegistryData:output_type -> controller_routing.GetAllControllerRegistryDataResponse
	10, // 32: controller_routing.ControllerRoutingService.HealthCheck:output_type -> controller_routing.ControllerHealthCheckResponse
	21, // 33: controller_routing.ControllerRoutingService.NotifyClientDisconnected:output_type -> controller_routing.NotifyClientDisconnectedResponse
