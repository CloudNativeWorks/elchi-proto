...
type Ipv4UnicastSummary struct {
	...
	Peers           map[string]*PeerSummary `protobuf:"bytes,12,rep,name=peers,proto3" json:"peers,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type ShowBgpSummary struct {
	state         protoimpl.MessageState         `protogen:"open.v1"`
	Instances     map[string]*BgpSummaryInstance `protobuf:"bytes,1,rep,name=instances,proto3" json:"instances,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type BgpSummaryInstance struct {
	...
	Peers         map[string]*BgpPeerSummaryInfo `protobuf:"bytes,8,rep,name=peers,proto3" json:"peers,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ShowBgpNeighbors struct {
	state         protoimpl.MessageState      `protogen:"open.v1"`
	Neighbors     map[string]*BgpNeighborInfo `protobuf:"bytes,1,rep,name=neighbors,proto3" json:"neighbors,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type BgpGracefulRestartInfo struct {
	state         protoimpl.MessageState    `protogen:"open.v1"`
	EndOfRibSend  map[string]bool           `protobuf:"bytes,1,rep,name=end_of_rib_send,json=endOfRibSend,proto3" json:"end_of_rib_send,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	EndOfRibRecv  map[string]bool           `protobuf:"bytes,2,rep,name=end_of_rib_recv,json=endOfRibRecv,proto3" json:"end_of_rib_recv,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
type ReceivedRoutes struct {
	...
	Routes        map[string]*RouteEntry `protobuf:"bytes,4,rep,name=routes,proto3" json:"routes,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type AdvertisedRoutes struct {
	...
	Advertised          map[string]*AdvertisedRouteEntry `protobuf:"bytes,8,rep,name=advertised,proto3" json:"advertised,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
type BgpPolicyConfig struct {
	...
	PolicyStatistics map[string]string      `protobuf:"bytes,4,rep,name=policy_statistics,json=policyStatistics,proto3" json:"policy_statistics,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
const file_client_frr_proto_rawDesc = "" +
	"\n" +
	"\x10client/frr.proto\x12\x06client\"\xe1\x03\n" +
	"\n" +
	"RequestBgp\x126\n" +
	"\toperation\x18\x01 \x01(\x0e2\x18.client.BgpOperationTypeR\toperation\x12)\n" +
	"\x06config\x18\x02 \x01(\v2\x11.client.BgpConfigR\x06config\x12/\n" +
	"\bneighbor\x18\x03 \x01(\v2\x13.client.BgpNeighborR\bneighbor\x12\x17\n" +
	"\apeer_ip\x18\x04 \x01(\tR\x06peerIp\x120\n" +
	"\troute_map\x18\x05 \x01(\v2\x13.client.BgpRouteMapR\brouteMap\x12?\n" +
	"\x0ecommunity_list\x18\x06 \x01(\v2\x18.client.BgpCommunityListR\rcommunityList\x126\n" +
	"\vprefix_list\x18\a \x01(\v2\x15.client.BgpPrefixListR\n" +
	"prefixList\x12\x1b\n" +
	"\tas_number\x18\b \x01(\rR\basNumber\x12\x19\n" +
	"\blocal_as\x18\t \x01(\rR\alocalAs\x12\x1b\n" +
	"\tremote_as\x18\n" +
	" \x01(\rR\bremoteAs\x12&\n" +
	"\x05clear\x18\v \x01(\v2\x10.client.ClearBgpR\x05clear\"X\n" +
	"\bClearBgp\x12\x12\n" +
	"\x04soft\x18\x01 \x01(\bR\x04soft\x12\x1c\n" +
	"\tdirection\x18\x02 \x01(\tR\tdirection\x12\x1a\n" +
	"\bneighbor\x18\x03 \x01(\tR\bneighbor\"\x9f\t\n" +
	"\tBgpConfig\x12+\n" +
	"\x11autonomous_system\x18\x01 \x01(\rR\x10autonomousSystem\x12\x1b\n" +
	"\trouter_id\x18\x02 \x01(\tR\brouterId\x121\n" +
	"\tneighbors\x18\x03 \x03(\v2\x13.client.BgpNeighborR\tneighbors\x12%\n" +
	"\x0ekeepalive_time\x18\x05 \x01(\rR\rkeepaliveTime\x12\x1b\n" +
	"\thold_time\x18\x06 \x01(\rR\bholdTime\x125\n" +
	"\x16redistribute_connected\x18\a \x01(\bR\x15redistributeConnected\x12/\n" +
	"\x13redistribute_static\x18\b \x01(\bR\x12redistributeStatic\x12/\n" +
	"\x13redistribute_kernel\x18\t \x01(\bR\x12redistributeKernel\x12-\n" +
	"\x12redistribute_local\x18\n" +
	" \x01(\bR\x11redistributeLocal\x122\n" +
	"\n" +
	"route_maps\x18\v \x03(\v2\x13.client.BgpRouteMapR\trouteMaps\x12A\n" +
	"\x0fcommunity_lists\x18\f \x03(\v2\x18.client.BgpCommunityListR\x0ecommunityLists\x128\n" +
	"\fprefix_lists\x18\r \x03(\v2\x15.client.BgpPrefixListR\vprefixLists\x12#\n" +
	"\rmaximum_paths\x18\x0e \x01(\rR\fmaximumPaths\x127\n" +
	"\x17administrative_distance\x18\x0f \x01(\tR\x16administrativeDistance\x12+\n" +
	"\x11deterministic_med\x18\x10 \x01(\bR\x10deterministicMed\x12,\n" +
	"\x12always_compare_med\x18\x11 \x01(\bR\x10alwaysCompareMed\x120\n" +
	"\x14log_neighbor_changes\x18\x12 \x01(\bR\x12logNeighborChanges\x128\n" +
	"\x18graceful_restart_enabled\x18\x13 \x01(\bR\x16gracefulRestartEnabled\x122\n" +
	"\x15graceful_restart_time\x18\x14 \x01(\rR\x13gracefulRestartTime\x127\n" +
	"\x18graceful_stale_path_time\x18\x15 \x01(\rR\x15gracefulStalePathTime\x12:\n" +
	"\x19preserve_forwarding_state\x18\x16 \x01(\bR\x17preserveForwardingState\x128\n" +
	"\x18graceful_restart_disable\x18\x17 \x01(\bR\x16gracefulRestartDisable\x12*\n" +
	"\x11select_defer_time\x18\x18 \x01(\rR\x0fselectDeferTime\x12$\n" +
	"\x0erib_stale_time\x18\x19 \x01(\rR\fribStaleTime\"\x90\x04\n" +
	"\vResponseBgp\x126\n" +
	"\toperation\x18\x01 \x01(\x0e2\x18.client.BgpOperationTypeR\toperation\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\x12)\n" +
	"\x06config\x18\x04 \x01(\v2\x11.client.BgpConfigR\x06config\x124\n" +
	"\asummary\x18\x05 \x01(\v2\x1a.client.Ipv4UnicastSummaryR\asummary\x12?\n" +
	"\x0eshow_neighbors\x18\x06 \x01(\v2\x18.client.ShowBgpNeighborsR\rshowNeighbors\x12/\n" +
	"\bneighbor\x18\a \x01(\v2\x13.client.BgpNeighborR\bneighbor\x12<\n" +
	"\rpolicy_config\x18\b \x01(\v2\x17.client.BgpPolicyConfigR\fpolicyConfig\x12&\n" +
	"\x06routes\x18\t \x01(\v2\x0e.client.RoutesR\x06routes\x12+\n" +
	"\x11validation_errors\x18\n" +
	" \x03(\tR\x10validationErrors\x12/\n" +
	"\x13validation_warnings\x18\v \x03(\tR\x12validationWarnings\"\xb9\x05\n" +
	"\x12Ipv4UnicastSummary\x12\x1a\n" +
	"\brouterId\x18\x01 \x01(\tR\brouterId\x12\x1a\n" +
	"\basNumber\x18\x02 \x01(\rR\basNumber\x12\x14\n" +
	"\x05vrfId\x18\x03 \x01(\rR\x05vrfId\x12\x18\n" +
	"\avrfName\x18\x04 \x01(\tR\avrfName\x12\"\n" +
	"\ftableVersion\x18\x05 \x01(\x04R\ftableVersion\x12\x1a\n" +
	"\bribCount\x18\x06 \x01(\x04R\bribCount\x12\x1c\n" +
	"\tribMemory\x18\a \x01(\x04R\tribMemory\x12\x1c\n" +
	"\tpeerCount\x18\b \x01(\rR\tpeerCount\x12\x1e\n" +
	"\n" +
	"peerMemory\x18\t \x01(\x04R\n" +
	"peerMemory\x12&\n" +
	"\x0epeerGroupCount\x18\n" +
	" \x01(\rR\x0epeerGroupCount\x12(\n" +
	"\x0fpeerGroupMemory\x18\v \x01(\x04R\x0fpeerGroupMemory\x12;\n" +
	"\x05peers\x18\f \x03(\v2%.client.Ipv4UnicastSummary.PeersEntryR\x05peers\x12 \n" +
	"\vfailedPeers\x18\r \x01(\rR\vfailedPeers\x12&\n" +
	"\x0edisplayedPeers\x18\x0e \x01(\rR\x0edisplayedPeers\x12\x1e\n" +
	"\n" +
	"totalPeers\x18\x0f \x01(\rR\n" +
	"totalPeers\x12\"\n" +
	"\fdynamicPeers\x18\x10 \x01(\rR\fdynamicPeers\x123\n" +
	"\bbestPath\x18\x11 \x01(\v2\x17.client.BestPathOptionsR\bbestPath\x1aM\n" +
	"\n" +
	"PeersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12)\n" +
	"\x05value\x18\x02 \x01(\v2\x13.client.PeerSummaryR\x05value:\x028\x01\"\x85\x05\n" +
	"\vPeerSummary\x12(\n" +
	"\x0fsoftwareVersion\x18\x01 \x01(\tR\x0fsoftwareVersion\x12\x1a\n" +
	"\bremoteAs\x18\x02 \x01(\rR\bremoteAs\x12\x18\n" +
	"\alocalAs\x18\x03 \x01(\rR\alocalAs\x12\x18\n" +
	"\aversion\x18\x04 \x01(\rR\aversion\x12\x18\n" +
	"\amsgRcvd\x18\x05 \x01(\x04R\amsgRcvd\x12\x18\n" +
	"\amsgSent\x18\x06 \x01(\x04R\amsgSent\x12\"\n" +
	"\ftableVersion\x18\a \x01(\x04R\ftableVersion\x12\x12\n" +
	"\x04outq\x18\b \x01(\rR\x04outq\x12\x10\n" +
	"\x03inq\x18\t \x01(\rR\x03inq\x12\x1e\n" +
	"\n" +
	"peerUptime\x18\n" +
	" \x01(\tR\n" +
	"peerUptime\x12&\n" +
	"\x0epeerUptimeMsec\x18\v \x01(\x04R\x0epeerUptimeMsec\x12>\n" +
	"\x1apeerUptimeEstablishedEpoch\x18\f \x01(\x04R\x1apeerUptimeEstablishedEpoch\x12\x16\n" +
	"\x06pfxRcd\x18\r \x01(\rR\x06pfxRcd\x12\x16\n" +
	"\x06pfxSnt\x18\x0e \x01(\rR\x06pfxSnt\x12\x14\n" +
	"\x05state\x18\x0f \x01(\tR\x05state\x12\x1c\n" +
	"\tpeerState\x18\x10 \x01(\tR\tpeerState\x126\n" +
	"\x16connectionsEstablished\x18\x11 \x01(\rR\x16connectionsEstablished\x12.\n" +
	"\x12connectionsDropped\x18\x12 \x01(\rR\x12connectionsDropped\x12\x12\n" +
	...
	"\x06timers\x18\x05 \x01(\v2\x19.client.BgpNeighborTimersR\x06timers\x12;\n" +
	"\n" +
	"route_maps\x18\x06 \x01(\v2\x1c.client.BgpNeighborRouteMapsR\trouteMaps\x12A\n" +
	"\fprefix_lists\x18\a \x01(\v2\x1e.client.BgpNeighborPrefixListsR\vprefixLists\x12\"\n" +
	"\rnext_hop_self\x18\b \x01(\bR\vnextHopSelf\x121\n" +
	"\x14soft_reconfiguration\x18\t \x01(\bR\x13softReconfiguration\x12\x1a\n" +
	"\bshutdown\x18\n" +
	" \x01(\bR\bshutdown\x12#\n" +
	"\rupdate_source\x18\v \x01(\tR\fupdateSource\x12%\n" +
	"\x0emaximum_prefix\x18\f \x01(\rR\rmaximumPrefix\x12,\n" +
	"\x12maximum_prefix_out\x18\r \x01(\rR\x10maximumPrefixOut\x12\x1d\n" +
	"\n" +
	"allowas_in\x18\x0e \x01(\rR\tallowasIn\x12\x16\n" +
	"\x06weight\x18\x0f \x01(\rR\x06weight\x12#\n" +
	"\rebgp_multihop\x18\x10 \x01(\bR\febgpMultihop\x12*\n" +
	"\x11ebgp_multihop_ttl\x18\x11 \x01(\rR\x0febgpMultihopTtl\x126\n" +
	...
	"\rconnect_retry\x18\x03 \x01(\rR\fconnectRetry\"\\\n" +
	"\x14BgpNeighborRouteMaps\x12 \n" +
	"\froute_map_in\x18\x01 \x03(\tR\n" +
	"routeMapIn\x12\"\n" +
	"\rroute_map_out\x18\x02 \x03(\tR\vrouteMapOut\"f\n" +
	"\x16BgpNeighborPrefixLists\x12$\n" +
	"\x0eprefix_list_in\x18\x01 \x03(\tR\fprefixListIn\x12&\n" +
	"\x0fprefix_list_out\x18\x02 \x03(\tR\rprefixListOut\"\x90\x02\n" +
	"\vBgpRouteMap\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1a\n" +
	"\bsequence\x18\x02 \x01(\rR\bsequence\x121\n" +
	"\x06action\x18\x03 \x01(\x0e2\x19.client.BgpRouteMapActionR\x06action\x12C\n" +
	"\x10match_conditions\x18\x04 \x03(\v2\x18.client.BgpRouteMapMatchR\x0fmatchConditions\x127\n" +
	"\vset_actions\x18\x05 \x01(\v2\x16.client.BgpRouteMapSetR\n" +
	"setActions\x12 \n" +
	"\vdescription\x18\x06 \x01(\tR\vdescription\"R\n" +
	"\x10BgpRouteMapMatch\x12\x1d\n" +
	"\n" +
	"match_type\x18\x01 \x01(\tR\tmatchType\x12\x1f\n" +
	"\vmatch_value\x18\x02 \x01(\tR\n" +
	"matchValue\"\xa7\x01\n" +
	"\x0eBgpRouteMapSet\x120\n" +
	"\x14set_local_preference\x18\x01 \x01(\rR\x12setLocalPreference\x12\x1d\n" +
	"\n" +
	"set_metric\x18\x02 \x01(\rR\tsetMetric\x12#\n" +
	"\rset_community\x18\x03 \x01(\tR\fsetCommunity\x12\x1f\n" +
	"\vset_nexthop\x18\x04 \x01(\tR\n" +
	"setNexthop\"\xb4\x01\n" +
	"\x10BgpCommunityList\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1a\n" +
	"\bsequence\x18\x02 \x01(\rR\bsequence\x121\n" +
	"\x06action\x18\x03 \x01(\x0e2\x19.client.BgpRouteMapActionR\x06action\x12)\n" +
	"\x10community_values\x18\x04 \x01(\tR\x0fcommunityValues\x12\x12\n" +
	"\x04type\x18\x05 \x01(\tR\x04type\"\xaa\x01\n" +
	"\rBgpPrefixList\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1a\n" +
	"\bsequence\x18\x02 \x01(\rR\bsequence\x121\n" +
	"\x06action\x18\x03 \x01(\x0e2\x19.client.BgpRouteMapActionR\x06action\x12\x16\n" +
	"\x06prefix\x18\x04 \x01(\tR\x06prefix\x12\x0e\n" +
	"\x02le\x18\x05 \x01(\rR\x02le\x12\x0e\n" +
	"\x02ge\x18\x06 \x01(\rR\x02ge\"\xaf\x01\n" +
	"\x0eShowBgpSummary\x12C\n" +
	"\tinstances\x18\x01 \x03(\v2%.client.ShowBgpSummary.InstancesEntryR\tinstances\x1aX\n" +
	"\x0eInstancesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x120\n" +
	"\x05value\x18\x02 \x01(\v2\x1a.client.BgpSummaryInstanceR\x05value:\x028\x01\"\xf9\x02\n" +
	"\x12BgpSummaryInstance\x12\x1b\n" +
	"\trouter_id\x18\x01 \x01(\rR\brouterId\x12\x0e\n" +
	"\x02as\x18\x02 \x01(\rR\x02as\x12#\n" +
	"\rtable_version\x18\x03 \x01(\x04R\ftableVersion\x12\x1f\n" +
	"\vrib_entries\x18\x04 \x01(\rR\n" +
	"ribEntries\x12\x1d\n" +
	"\n" +
	"rib_memory\x18\x05 \x01(\rR\tribMemory\x12\x1d\n" +
	"\n" +
	"peer_count\x18\x06 \x01(\rR\tpeerCount\x12\x1f\n" +
	"\vpeer_memory\x18\a \x01(\rR\n" +
	"peerMemory\x12;\n" +
	"\x05peers\x18\b \x03(\v2%.client.BgpSummaryInstance.PeersEntryR\x05peers\x1aT\n" +
	"\n" +
	"PeersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x120\n" +
	"\x05value\x18\x02 \x01(\v2\x1a.client.BgpPeerSummaryInfoR\x05value:\x028\x01\"\xe8\x01\n" +
	"\x12BgpPeerSummaryInfo\x12\x1b\n" +
	"\tremote_as\x18\x01 \x01(\rR\bremoteAs\x12\x19\n" +
	"\blocal_as\x18\x02 \x01(\rR\alocalAs\x12\x14\n" +
	"\x05state\x18\x03 \x01(\tR\x05state\x12\x16\n" +
	"\x06uptime\x18\x04 \x01(\x04R\x06uptime\x12'\n" +
	"\x0fprefix_received\x18\x05 \x01(\rR\x0eprefixReceived\x12\x1f\n" +
	"\vprefix_sent\x18\x06 \x01(\rR\n" +
	"prefixSent\x12\"\n" +
	"\rstate_pfx_rcd\x18\a \x01(\tR\vstatePfxRcd\"\xb0\x01\n" +
	"\x10ShowBgpNeighbors\x12E\n" +
	"\tneighbors\x18\x01 \x03(\v2'.client.ShowBgpNeighbors.NeighborsEntryR\tneighbors\x1aU\n" +
	"\x0eNeighborsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12-\n" +
	"\x05value\x18\x02 \x01(\v2\x17.client.BgpNeighborInfoR\x05value:\x028\x01\"\xd0\x12\n" +
	"\x0fBgpNeighborInfo\x12\x1b\n" +
	"\tremote_as\x18\x01 \x01(\rR\bremoteAs\x12\x19\n" +
	"\blocal_as\x18\x02 \x01(\rR\alocalAs\x12;\n" +
	"\x1blocal_as_replace_as_dual_as\x18\x03 \x01(\bR\x16localAsReplaceAsDualAs\x12*\n" +
	"\x11nbr_external_link\x18\x04 \x01(\bR\x0fnbrExternalLink\x12\x1d\n" +
	"\n" +
	"local_role\x18\x05 \x01(\tR\tlocalRole\x12\x1f\n" +
	"\vremote_role\x18\x06 \x01(\tR\n" +
	"remoteRole\x12\x19\n" +
	"\bnbr_desc\x18\a \x01(\tR\anbrDesc\x12\x1a\n" +
	"\bhostname\x18\b \x01(\tR\bhostname\x12\x1f\n" +
	"\vbgp_version\x18\t \x01(\rR\n" +
	"bgpVersion\x12(\n" +
	"\x10remote_router_id\x18\n" +
	" \x01(\tR\x0eremoteRouterId\x12&\n" +
	"\x0flocal_router_id\x18\v \x01(\tR\rlocalRouterId\x12\x1b\n" +
	"\tbgp_state\x18\f \x01(\tR\bbgpState\x12-\n" +
	"\x13bgp_timer_last_read\x18\r \x01(\x04R\x10bgpTimerLastRead\x12/\n" +
	"\x14bgp_timer_last_write\x18\x0e \x01(\x04R\x11bgpTimerLastWrite\x12E\n" +
	" bgp_in_update_elapsed_time_msecs\x18\x0f \x01(\x04R\x1bbgpInUpdateElapsedTimeMsecs\x12M\n" +
	"$bgp_timer_configured_hold_time_msecs\x18\x10 \x01(\x04R\x1fbgpTimerConfiguredHoldTimeMsecs\x12`\n" +
	".bgp_timer_configured_keep_alive_interval_msecs\x18\x11 \x01(\x04R(bgpTimerConfiguredKeepAliveIntervalMsecs\x128\n" +
	"\x19bgp_timer_hold_time_msecs\x18\x12 \x01(\x04R\x15bgpTimerHoldTimeMsecs\x12K\n" +
	"#bgp_timer_keep_alive_interval_msecs\x18\x13 \x01(\x04R\x1ebgpTimerKeepAliveIntervalMsecs\x123\n" +
	"\x16bgp_tcp_mss_configured\x18\x14 \x01(\rR\x13bgpTcpMssConfigured\x12+\n" +
	"\x12bgp_tcp_mss_synced\x18\x15 \x01(\rR\x0fbgpTcpMssSynced\x12M\n" +
	"#extended_optional_parameters_length\x18\x16 \x01(\bR extendedOptionalParametersLength\x12k\n" +
	"3bgp_timer_configured_conditional_advertisements_sec\x18\x17 \x01(\rR.bgpTimerConfiguredConditionalAdvertisementsSec\x12R\n" +
	"\x15graceful_restart_info\x18\x18 \x01(\v2\x1e.client.BgpGracefulRestartInfoR\x13gracefulRestartInfo\x12<\n" +
	"\rmessage_stats\x18\x19 \x01(\v2\x17.client.BgpMessageStatsR\fmessageStats\x129\n" +
	"\fprefix_stats\x18\x1a \x01(\v2\x16.client.BgpPrefixStatsR\vprefixStats\x12S\n" +
	"'min_btwn_advertisement_runs_timer_msecs\x18\x1b \x01(\rR\"minBtwnAdvertisementRunsTimerMsecs\x12L\n" +
	"\x13address_family_info\x18\x1c \x01(\v2\x1c.client.BgpAddressFamilyInfoR\x11addressFamilyInfo\x127\n" +
	"\x17connections_established\x18\x1d \x01(\rR\x16connectionsEstablished\x12/\n" +
	"\x13connections_dropped\x18\x1e \x01(\rR\x12connectionsDropped\x123\n" +
	"\x16last_reset_timer_msecs\x18\x1f \x01(\x04R\x13lastResetTimerMsecs\x12)\n" +
	"\x11last_reset_due_to\x18  \x01(\tR\x0elastResetDueTo\x12&\n" +
	"\x0flast_reset_code\x18! \x01(\rR\rlastResetCode\x12)\n" +
	"\x10software_version\x18\" \x01(\tR\x0fsoftwareVersion\x12A\n" +
	"\x1eexternal_bgp_nbr_max_hops_away\x18# \x01(\rR\x19externalBgpNbrMaxHopsAway\x12\x1d\n" +
	"\n" +
	"host_local\x18$ \x01(\tR\thostLocal\x12\x1d\n" +
	"\n" +
	"port_local\x18% \x01(\rR\tportLocal\x12!\n" +
	"\fhost_foreign\x18& \x01(\tR\vhostForeign\x12!\n" +
	"\fport_foreign\x18' \x01(\rR\vportForeign\x12\x18\n" +
	"\anexthop\x18( \x01(\tR\anexthop\x12%\n" +
	"\x0enexthop_global\x18) \x01(\tR\rnexthopGlobal\x12#\n" +
	"\rnexthop_local\x18* \x01(\tR\fnexthopLocal\x12%\n" +
	"\x0ebgp_connection\x18+ \x01(\tR\rbgpConnection\x12.\n" +
	"\x13connect_retry_timer\x18, \x01(\rR\x11connectRetryTimer\x12C\n" +
	"\x1fnext_connect_timer_due_in_msecs\x18- \x01(\x04R\x1anextConnectTimerDueInMsecs\x12\x1f\n" +
	"\vread_thread\x18. \x01(\tR\n" +
	"readThread\x12!\n" +
	"\fwrite_thread\x18/ \x01(\tR\vwriteThread\"\xfa\x03\n" +
	"\x16BgpGracefulRestartInfo\x12W\n" +
	"\x0fend_of_rib_send\x18\x01 \x03(\v20.client.BgpGracefulRestartInfo.EndOfRibSendEntryR\fendOfRibSend\x12W\n" +
	"\x0fend_of_rib_recv\x18\x02 \x03(\v20.client.BgpGracefulRestartInfo.EndOfRibRecvEntryR\fendOfRibRecv\x12\"\n" +
	"\rlocal_gr_mode\x18\x03 \x01(\tR\vlocalGrMode\x12$\n" +
	"\x0eremote_gr_mode\x18\x04 \x01(\tR\fremoteGrMode\x12\x13\n" +
	"\x05r_bit\x18\x05 \x01(\bR\x04rBit\x12\x13\n" +
	"\x05n_bit\x18\x06 \x01(\bR\x04nBit\x128\n" +
	"\x06timers\x18\a \x01(\v2 .client.BgpGracefulRestartTimersR\x06timers\x1a?\n" +
	"\x11EndOfRibSendEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\bR\x05value:\x028\x01\x1a?\n" +
	"\x11EndOfRibRecvEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\bR\x05value:\x028\x01\"\xc7\x01\n" +
	"\x18BgpGracefulRestartTimers\x128\n" +
	"\x18configured_restart_timer\x18\x01 \x01(\rR\x16configuredRestartTimer\x12;\n" +
	"\x1aconfigured_llgr_stale_time\x18\x02 \x01(\rR\x17configuredLlgrStaleTime\x124\n" +
	"\x16received_restart_timer\x18\x03 \x01(\rR\x14receivedRestartTimer\"\xed\x04\n" +
	"\x0fBgpMessageStats\x12\x1b\n" +
	"\tdepth_inq\x18\x01 \x01(\rR\bdepthInq\x12\x1d\n" +
	"\n" +
	"depth_outq\x18\x02 \x01(\rR\tdepthOutq\x12\x1d\n" +
	"\n" +
	"opens_sent\x18\x03 \x01(\rR\topensSent\x12\x1d\n" +
	"\n" +
	"opens_recv\x18\x04 \x01(\rR\topensRecv\x12-\n" +
	"\x12notifications_sent\x18\x05 \x01(\rR\x11notificationsSent\x12-\n" +
	"\x12notifications_recv\x18\x06 \x01(\rR\x11notificationsRecv\x12!\n" +
	"\fupdates_sent\x18\a \x01(\rR\vupdatesSent\x12!\n" +
	"\fupdates_recv\x18\b \x01(\rR\vupdatesRecv\x12'\n" +
	"\x0fkeepalives_sent\x18\t \x01(\rR\x0ekeepalivesSent\x12'\n" +
	"\x0fkeepalives_recv\x18\n" +
	" \x01(\rR\x0ekeepalivesRecv\x12,\n" +
	"\x12route_refresh_sent\x18\v \x01(\rR\x10routeRefreshSent\x12,\n" +
	"\x12route_refresh_recv\x18\f \x01(\rR\x10routeRefreshRecv\x12'\n" +
	"\x0fcapability_sent\x18\r \x01(\rR\x0ecapabilitySent\x12'\n" +
	"\x0fcapability_recv\x18\x0e \x01(\rR\x0ecapabilityRecv\x12\x1d\n" +
	"\n" +
	"total_sent\x18\x0f \x01(\rR\ttotalSent\x12\x1d\n" +
	"\n" +
	"total_recv\x18\x10 \x01(\rR\ttotalRecv\"\xa3\x02\n" +
	"\x0eBgpPrefixStats\x12)\n" +
	"\x10inbound_filtered\x18\x01 \x01(\rR\x0finboundFiltered\x12\x1f\n" +
	"\vaspath_loop\x18\x02 \x01(\rR\n" +
	"aspathLoop\x12'\n" +
	"\x0foriginator_loop\x18\x03 \x01(\rR\x0eoriginatorLoop\x12!\n" +
	"\fcluster_loop\x18\x04 \x01(\rR\vclusterLoop\x12(\n" +
	"\x10invalid_next_hop\x18\x05 \x01(\rR\x0einvalidNextHop\x12\x1c\n" +
	"\twithdrawn\x18\x06 \x01(\rR\twithdrawn\x121\n" +
	"\x14attributes_discarded\x18\a \x01(\rR\x13attributesDiscarded\"U\n" +
	"\x14BgpAddressFamilyInfo\x12=\n" +
	"\fipv4_unicast\x18\x01 \x01(\v2\x1a.client.BgpIpv4UnicastInfoR\vipv4Unicast\"\xb9\x02\n" +
	"\x12BgpIpv4UnicastInfo\x122\n" +
	"\x16comm_attri_sent_to_nbr\x18\x01 \x01(\tR\x12commAttriSentToNbr\x12?\n" +
	"\x1cinbound_ebgp_requires_policy\x18\x02 \x01(\tR\x19inboundEbgpRequiresPolicy\x12A\n" +
	"\x1doutbound_ebgp_requires_policy\x18\x03 \x01(\tR\x1aoutboundEbgpRequiresPolicy\x126\n" +
	"\x17accepted_prefix_counter\x18\x04 \x01(\rR\x15acceptedPrefixCounter\x123\n" +
	"\x16router_always_next_hop\x18\x05 \x01(\bR\x13routerAlwaysNextHop\"v\n" +
	"\x06Routes\x122\n" +
	"\breceived\x18\x01 \x01(\v2\x16.client.ReceivedRoutesR\breceived\x128\n" +
	"\n" +
	"advertised\x18\x02 \x03(\v2\x18.client.AdvertisedRoutesR\n" +
	"advertised\"\xfc\x01\n" +
	"\x0eReceivedRoutes\x12!\n" +
	"\ftotal_routes\x18\x01 \x01(\rR\vtotalRoutes\x12\x1f\n" +
	"\vtotal_paths\x18\x02 \x01(\rR\n" +
	"totalPaths\x12\x1b\n" +
	"\trouter_id\x18\x03 \x01(\tR\brouterId\x12:\n" +
	"\x06routes\x18\x04 \x03(\v2\".client.ReceivedRoutes.RoutesEntryR\x06routes\x1aM\n" +
	"\vRoutesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12(\n" +
	"\x05value\x18\x02 \x01(\v2\x12.client.RouteEntryR\x05value:\x028\x01\"0\n" +
	"\n" +
	"RouteEntry\x12\"\n" +
	"\x05paths\x18\x01 \x03(\v2\f.client.PathR\x05paths\"\x8d\x03\n" +
	"\x04Path\x12\x14\n" +
	"\x05valid\x18\x01 \x01(\bR\x05valid\x12\x1a\n" +
	"\bbestpath\x18\x02 \x01(\bR\bbestpath\x12)\n" +
	"\x10selection_reason\x18\x03 \x01(\tR\x0fselectionReason\x12\x1b\n" +
	"\tpath_from\x18\x04 \x01(\tR\bpathFrom\x12\x16\n" +
	"\x06prefix\x18\x05 \x01(\tR\x06prefix\x12\x1d\n" +
	"\n" +
	"prefix_len\x18\x06 \x01(\rR\tprefixLen\x12\x18\n" +
	"\anetwork\x18\a \x01(\tR\anetwork\x12\x18\n" +
	"\aversion\x18\b \x01(\rR\aversion\x12\x16\n" +
	"\x06metric\x18\t \x01(\rR\x06metric\x12\x16\n" +
	"\x06weight\x18\n" +
	" \x01(\rR\x06weight\x12\x17\n" +
	"\apeer_id\x18\v \x01(\tR\x06peerId\x12\x12\n" +
	"\x04path\x18\f \x01(\tR\x04path\x12\x16\n" +
	"\x06origin\x18\r \x01(\tR\x06origin\x12+\n" +
	"\bnexthops\x18\x0e \x03(\v2\x0f.client.NexthopR\bnexthops\"[\n" +
	"\aNexthop\x12\x0e\n" +
	"\x02ip\x18\x01 \x01(\tR\x02ip\x12\x1a\n" +
	"\bhostname\x18\x02 \x01(\tR\bhostname\x12\x10\n" +
	"\x03afi\x18\x03 \x01(\tR\x03afi\x12\x12\n" +
	"\x04used\x18\x04 \x01(\bR\x04used\"\xce\x03\n" +
	"\x10AdvertisedRoutes\x12\x1f\n" +
	"\vneighbor_ip\x18\x01 \x01(\tR\n" +
	"neighborIp\x12\x1b\n" +
	"\trouter_id\x18\x02 \x01(\tR\brouterId\x12*\n" +
	"\x11bgp_table_version\x18\x03 \x01(\rR\x0fbgpTableVersion\x12\x19\n" +
	"\blocal_as\x18\x04 \x01(\rR\alocalAs\x12,\n" +
	"\x12default_local_pref\x18\x05 \x01(\rR\x10defaultLocalPref\x12,\n" +
	"\x12total_prefix_count\x18\x06 \x01(\rR\x10totalPrefixCount\x122\n" +
	"\x15filtered_prefix_count\x18\a \x01(\rR\x13filteredPrefixCount\x12H\n" +
	"\n" +
	"advertised\x18\b \x03(\v2(.client.AdvertisedRoutes.AdvertisedEntryR\n" +
	"advertised\x1a[\n" +
	"\x0fAdvertisedEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x122\n" +
	"\x05value\x18\x02 \x01(\v2\x1c.client.AdvertisedRouteEntryR\x05value:\x028\x01\"\x91\x02\n" +
	"\x14AdvertisedRouteEntry\x12\x1f\n" +
	"\vaddr_prefix\x18\x01 \x01(\tR\n" +
	"addrPrefix\x12\x1d\n" +
	"\n" +
	"prefix_len\x18\x02 \x01(\rR\tprefixLen\x12\x18\n" +
	"\anetwork\x18\x03 \x01(\tR\anetwork\x12\x19\n" +
	"\bnext_hop\x18\x04 \x01(\tR\anextHop\x12\x16\n" +
	"\x06metric\x18\x05 \x01(\rR\x06metric\x12\x16\n" +
	"\x06weight\x18\x06 \x01(\rR\x06weight\x12\x12\n" +
	"\x04path\x18\a \x01(\tR\x04path\x12\x16\n" +
	"\x06origin\x18\b \x01(\tR\x06origin\x12\x14\n" +
	"\x05valid\x18\t \x01(\bR\x05valid\x12\x12\n" +
	"\x04best\x18\n" +
	" \x01(\bR\x04best\"\xe3\x02\n" +
	"\x0fBgpPolicyConfig\x122\n" +
	"\n" +
	"route_maps\x18\x01 \x03(\v2\x13.client.BgpRouteMapR\trouteMaps\x12A\n" +
	"\x0fcommunity_lists\x18\x02 \x03(\v2\x18.client.BgpCommunityListR\x0ecommunityLists\x128\n" +
	"\fprefix_lists\x18\x03 \x03(\v2\x15.client.BgpPrefixListR\vprefixLists\x12Z\n" +
	"\x11policy_statistics\x18\x04 \x03(\v2-.client.BgpPolicyConfig.PolicyStatisticsEntryR\x10policyStatistics\x1aC\n" +
	"\x15PolicyStatisticsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01*A\n" +
	"\x0fFrrProtocolType\x12\x18\n" +
	"\x14FRR_PROTOCOL_UNKNOWN\x10\x00\x12\x14\n" +
	"\x10FRR_PROTOCOL_BGP\x10\x01*\xc3\x03\n" +
	"\x10BgpOperationType\x12\x0f\n" +
	"\vBGP_UNKNOWN\x10\x00\x12\x12\n" +
	"\x0eBGP_GET_CONFIG\x10\x01\x12\x12\n" +
	"\x0eBGP_SET_CONFIG\x10\x02\x12\x14\n" +
	"\x10BGP_ADD_NEIGHBOR\x10\x03\x12\x17\n" +
	"\x13BGP_UPDATE_NEIGHBOR\x10\x04\x12\x16\n" +
	"\x12BGP_LIST_NEIGHBORS\x10\x05\x12\x14\n" +
	"\x10BGP_GET_NEIGHBOR\x10\x06\x12\x17\n" +
	"\x13BGP_REMOVE_NEIGHBOR\x10\a\x12\x19\n" +
	"\x15BGP_GET_POLICY_CONFIG\x10\b\x12\x19\n" +
	"\x15BGP_APPLY_PREFIX_LIST\x10\t\x12\x1a\n" +
	"\x16BGP_REMOVE_PREFIX_LIST\x10\n" +
	"\x12\x1c\n" +
	"\x18BGP_APPLY_COMMUNITY_LIST\x10\v\x12\x1d\n" +
	"\x19BGP_REMOVE_COMMUNITY_LIST\x10\f\x12\x17\n" +
	"\x13BGP_APPLY_ROUTE_MAP\x10\r\x12\x18\n" +
	"\x14BGP_REMOVE_ROUTE_MAP\x10\x0e\x12\x13\n" +
	"\x0fBGP_SHOW_ROUTES\x10\x0f\x12\x13\n" +
	"\x0fBGP_GET_SUMMARY\x10\x10\x12\x14\n" +
	"\x10BGP_CLEAR_ROUTES\x10\x11*T\n" +
	"\x11BgpRouteMapAction\x12\x15\n" +
	"\x11ROUTE_MAP_UNKNOWN\x10\x00\x12\x14\n" +
	"\x10ROUTE_MAP_PERMIT\x10\x01\x12\x12\n" +
	"\x0eROUTE_MAP_DENY\x10\x02B0Z.github.com/CloudNativeWorks/elchi-proto/clientb\x06proto3"

var (
	file_client_frr_proto_rawDescOnce sync.Once
	file_client_frr_proto_rawDescData []byte
)

func file_client_frr_proto_rawDescGZIP() []byte {
	file_client_frr_proto_rawDescOnce.Do(func() {
		file_client_frr_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_client_frr_proto_rawDesc), len(file_client_frr_proto_rawDesc)))
	})
...
func file_client_frr_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_client_frr_proto_rawDesc), len(file_client_frr_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   44,
			NumExtensions: 0,
			NumServices:   0,
