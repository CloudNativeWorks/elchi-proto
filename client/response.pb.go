...
var file_client_response_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x67, 0x70, 0x52, 0x03, 0x62, 0x67, 0x70, 0x42,
...
var file_client_response_proto_goTypes = []any{
	...
	(*GeneralLogs)(nil),             // 7: client.GeneralLogs
	(*ResponseGeneralLog)(nil),      // 8: client.ResponseGeneralLog
	...
	nil,                             // 13: client.GeneralLogs.MetadataEntry
	...
	(*NetworkState)(nil),            // 19: client.NetworkState
...
var file_client_response_proto_depIdxs = []int32{
	...
	13, // 3: client.GeneralLogs.metadata:type_name -> client.GeneralLogs.MetadataEntry
	7,  // 4: client.ResponseGeneralLog.logs:type_name -> client.GeneralLogs
	...
	19, // 10: client.ResponseNetwork.network_state:type_name -> client.NetworkState
