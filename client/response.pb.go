...
type EnvoyVersionStatus int32

const (
	EnvoyVersionStatus_SUCCESS           EnvoyVersionStatus = 0
	EnvoyVersionStatus_DOWNLOAD_FAILED   EnvoyVersionStatus = 1
	EnvoyVersionStatus_EXTRACTION_FAILED EnvoyVersionStatus = 2
	EnvoyVersionStatus_PERMISSION_FAILED EnvoyVersionStatus = 3
	EnvoyVersionStatus_VERSION_NOT_FOUND EnvoyVersionStatus = 4
	EnvoyVersionStatus_NETWORK_ERROR     EnvoyVersionStatus = 5
	EnvoyVersionStatus_DIRECTORY_ERROR   EnvoyVersionStatus = 6
)

// Enum value maps for EnvoyVersionStatus.
var (
	EnvoyVersionStatus_name = map[int32]string{
		0: "SUCCESS",
		1: "DOWNLOAD_FAILED",
		2: "EXTRACTION_FAILED",
		3: "PERMISSION_FAILED",
	...
	EnvoyVersionStatus_value = map[string]int32{
		"SUCCESS":           0,
		"DOWNLOAD_FAILED":   1,
		"EXTRACTION_FAILED": 2,
		"PERMISSION_FAILED": 3,
...
func (x EnvoyVersionStatus) Enum() *EnvoyVersionStatus {
	p := new(EnvoyVersionStatus)
	*p = x
	return p
}

func (x EnvoyVersionStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (EnvoyVersionStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_client_response_proto_enumTypes[0].Descriptor()
}

func (EnvoyVersionStatus) Type() protoreflect.EnumType {
	return &file_client_response_proto_enumTypes[0]
}

func (x EnvoyVersionStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use EnvoyVersionStatus.Descriptor instead.
func (EnvoyVersionStatus) EnumDescriptor() ([]byte, []int) {
...
type ResponseEnvoyVersion struct {
	...
	DownloadedVersions []string           `protobuf:"bytes,1,rep,name=downloaded_versions,json=downloadedVersions,proto3" json:"downloaded_versions,omitempty"` // GET_VERSIONS için: v1.34.2, v1.35.0 gibi
	InstalledVersion   string             `protobuf:"bytes,2,opt,name=installed_version,json=installedVersion,proto3" json:"installed_version,omitempty"`       // SET_VERSION için: kurulu version
	DownloadPath       string             `protobuf:"bytes,3,opt,name=download_path,json=downloadPath,proto3" json:"download_path,omitempty"`                   // SET_VERSION için: kurulum path'i
	Status             EnvoyVersionStatus `protobuf:"varint,4,opt,name=status,proto3,enum=client.EnvoyVersionStatus" json:"status,omitempty"`
...
func (x *ResponseEnvoyVersion) GetStatus() EnvoyVersionStatus {
	if x != nil {
		return x.Status
	}
	return EnvoyVersionStatus_SUCCESS
}
...
var file_client_response_proto_rawDesc = []byte{
	...
	0x74, 0x2f, 0x66, 0x72, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd9, 0x01, 0x0a, 0x0e,
	...
	0x06, 0x69, 0x70, 0x4d, 0x6f, 0x64, 0x65, 0x22, 0xdb, 0x01, 0x0a, 0x10, 0x52, 0x65, 0x73, 0x70,
	...
	0x70, 0x4d, 0x6f, 0x64, 0x65, 0x22, 0x2d, 0x0a, 0x17, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x67, 0x70, 0x52, 0x03, 0x62, 0x67, 0x70, 0x22, 0xf2, 0x01, 0x0a, 0x14, 0x52, 0x65, 0x73, 0x70,
	...
	0x61, 0x74, 0x68, 0x12, 0x32, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x45, 0x6e, 0x76,
	0x6f, 0x79, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	...
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2a, 0xa3, 0x01, 0x0a,
	0x12, 0x45, 0x6e, 0x76, 0x6f, 0x79, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61,
	...
	0x4c, 0x45, 0x44, 0x10, 0x01, 0x12, 0x15, 0x0a, 0x11, 0x45, 0x58, 0x54, 0x52, 0x41, 0x43, 0x54,
	0x49, 0x4f, 0x4e, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x12, 0x15, 0x0a, 0x11,
	0x50, 0x45, 0x52, 0x4d, 0x49, 0x53, 0x53, 0x49, 0x4f, 0x4e, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45,
	0x44, 0x10, 0x03, 0x12, 0x15, 0x0a, 0x11, 0x56, 0x45, 0x52, 0x53, 0x49, 0x4f, 0x4e, 0x5f, 0x4e,
	0x4f, 0x54, 0x5f, 0x46, 0x4f, 0x55, 0x4e, 0x44, 0x10, 0x04, 0x12, 0x11, 0x0a, 0x0d, 0x4e, 0x45,
	0x54, 0x57, 0x4f, 0x52, 0x4b, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x05, 0x12, 0x13, 0x0a,
	0x0f, 0x44, 0x49, 0x52, 0x45, 0x43, 0x54, 0x4f, 0x52, 0x59, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52,
...
var file_client_response_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_client_response_proto_goTypes = []any{
	(EnvoyVersionStatus)(0),         // 0: client.EnvoyVersionStatus
	...
	nil,                             // 14: client.ResponseEnvoyAdmin.HeadersEntry
	nil,                             // 15: client.GeneralLogs.MetadataEntry
	(*CPUStats)(nil),                // 16: client.CPUStats
	(*MemoryStats)(nil),             // 17: client.MemoryStats
	(*DiskStats)(nil),               // 18: client.DiskStats
	(*NetworkStats)(nil),            // 19: client.NetworkStats
	(*SystemInfo)(nil),              // 20: client.SystemInfo
	(*NetworkState)(nil),            // 21: client.NetworkState
	(FrrProtocolType)(0),            // 22: client.FrrProtocolType
	(*ResponseBgp)(nil),             // 23: client.ResponseBgp
}
var file_client_response_proto_depIdxs = []int32{
	...
	14, // 2: client.ResponseEnvoyAdmin.headers:type_name -> client.ResponseEnvoyAdmin.HeadersEntry
	15, // 3: client.GeneralLogs.metadata:type_name -> client.GeneralLogs.MetadataEntry
	8,  // 4: client.ResponseGeneralLog.logs:type_name -> client.GeneralLogs
	16, // 5: client.ResponseClientStats.cpu:type_name -> client.CPUStats
	17, // 6: client.ResponseClientStats.memory:type_name -> client.MemoryStats
	18, // 7: client.ResponseClientStats.disk:type_name -> client.DiskStats
	19, // 8: client.ResponseClientStats.network:type_name -> client.NetworkStats
	20, // 9: client.ResponseClientStats.system:type_name -> client.SystemInfo
	21, // 10: client.ResponseNetwork.network_state:type_name -> client.NetworkState
	22, // 11: client.ResponseFrr.protocol:type_name -> client.FrrProtocolType
	23, // 12: client.ResponseFrr.bgp:type_name -> client.ResponseBgp
	0,  // 13: client.ResponseEnvoyVersion.status:type_name -> client.EnvoyVersionStatus
